...
import { useTextReader } from "../hooks/useTextReader.ts";
      ...
      >
        ...
        <ul>
          ...
          <li>
            ...
            <a href={textReaderText.summary.linkRef} target="_blank" rel="noopener noreferrer">
      ...
      <div className="textReaderContainer">
        ...
        >
          ...
          <div className="textReaderContainer__fileUploader__inputSelectGroup">
            <label htmlFor="upload-file" className="textReaderContainer__fileUploader__label" title={textReaderText.uploadText4}>
              <strong>{textReaderText.uploadText4}</strong>
            </label>
            <input id="upload-file" type="file" onClick={resetSelectFile} onChange={selectedFile} className="textReaderContainer__fileUploader__input" />
        ...
        {state.fileName && (
          <div className="textReaderContainer__header">
            ...
            {state.fileUploaderClose && (
              <button className="textReaderContainer__button" onClick={handleFileUploader}>
        ...
        {state.isLoading && !state.fileContent ? <Loading /> : <TextDisplay fileContent={state.fileContent} />}
      </div>
    </>
  );
};
